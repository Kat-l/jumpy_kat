...
ms1 = pygame.mixer.Sound('sound/pd.wav')
ms2 = pygame.mixer.Sound('sound/pd1.wav')
ms3 = pygame.mixer.Sound('sound/pd2.wav')
ms4 = pygame.mixer.Sound('sound/pd3.wav')
ms5 = pygame.mixer.Sound('sound/pd4.wav')
ms6 = pygame.mixer.Sound('sound/pd5.wav')
meow_sound = [ms1, ms2, ms3, ms4, ms5, ms6]
